...
SET "SERVERCFG=DEBUGMODE\mpmissions\Debug_Mode\serverDZ.cfg"

@REM Directory to your Servers Mission Files 
SET "MISSION=DEBUGMODE\mpmissions\Debug_Mode\dayzOffline.chernarusplus"

@REM Directory to your Servers Profiles Folder
SET "PROFILES=DEBUGMODE\mpmissions\Debug_Mode\profiles"
